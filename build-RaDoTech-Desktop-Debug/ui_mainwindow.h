...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        testButton = new QPushButton(tab_3);
        testButton->setObjectName(QString::fromUtf8("testButton"));
        testButton->setGeometry(QRect(0, 10, 771, 41));
        ...
        QObject::connect(startScanButton, SIGNAL(released()), MainWindow, SLOT(setFocus()));
...
"User Interface", nullptr));
        ...
        testButton->setText(QCoreApplication::translate("MainWindow", "Scan test", nullptr));
